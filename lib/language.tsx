...
const translations: Record<Language, Translations> = {
  en: {
    ...
    officialInfo: 'Siputra Digital Official Information',
    heroTitle: 'Terms & Policies',
    heroDescription: 'Service terms, policies, and official information of Siputra Digital.',
    ...
    allPagesDescription:
      'A clean central hub for legal, support, and service information related to Siputra Digital.',
  ...
  id: {
    ...
    officialInfo: 'Informasi Resmi Siputra Digital',
    heroTitle: 'Syarat & Kebijakan',
    heroDescription: 'Syarat layanan, kebijakan, dan informasi resmi Siputra Digital.',
    ...
    allPagesDescription:
      'Pusat informasi yang rapi untuk layanan hukum, dukungan, dan informasi resmi Siputra Digital.',
